...
/**
 * Класс хранит информацию о количестве шагов пользователя за месяц (в массиве),
 * реализует интерфейс MonthData.
 */
public class InMemoryMonthData implements MonthData{
